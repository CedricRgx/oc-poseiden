...
/**
 * The main class for the Poseidon application.
...
public class Application implements CommandLineRunner {
	...
	/**
	 * The entry point for the poseidon application. It initializes and starts the Spring Boot application.
	 ...
	 * It currently prints "poseidon UP !!" to the console.
	 * @param args The command-line arguments passed to the application.
	 */
	@Override
	@Transactional
	public void run(String... args) {
		System.out.println("Poseidon UP !!");
	}
}
